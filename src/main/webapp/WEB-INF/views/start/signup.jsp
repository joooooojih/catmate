            ...
            <div class="card-body">
              ...
              <form action="signup" method="post">
                <div class="form-group" >
                  ...
                  <input type="text" class="form-control" placeholder="생년월일  8자리" maxlength="8"><br>
                  <input type="text" class="form-control" placeholder="휴대폰 번호 -없이 11자리 입력" maxlength="11"><br>
                  <input type="text" id="sample6_postcode" class="form-control" onclick="sample6_execDaumPostcode()" placeholder="우편번호" ><br>
  				        <input type="text" id="sample6_address" class="form-control" onclick="sample6_execDaumPostcode()" placeholder="주소"><br>
				          <input type="text" id="sample6_address2" class="form-control" placeholder="상세주소"><br>
                </div>
