    ...
    <div class="container my-auto">
      <div class="row">
        ...
        <div class="col-lg-8 mx-auto">
          ...
          <a class="btn btn-primary btn-xl js-scroll-trigger" href="${pageContext.request.contextPath }/sregister/petSitter01">펫시터 등록하기</a>
        </div>
      </div>
    </div>
  </header>
    ...
    <div class="row">
      ...
      <div class="row">
        <div class="py-5 col-md-6">
          <div class="row">
            <div class="text-center col-4">
              <img src="${pageContext.request.contextPath }/resources/start/main/img/main_catmate1.png">
            </div>
            <div class="col-8">
        ...
        <div class="py-5 col-md-6">
          <div class="row">
            <div class="text-center col-4">
              <img src="${pageContext.request.contextPath }/resources/start/main/img/main_catmate2.png">
            </div>
            <div class="col-8">
              <h5 class="mb-3 text-primary">
                <b>오직 한마리!</b>
      ...
      <div class="row">
        <div class="py-5 col-md-6">
          <div class="row">
            <div class="text-center col-4">
              <img src="${pageContext.request.contextPath }/resources/start/main/img/main_catmate3.png">
            </div>
            <div class="col-8">
              <h5 class="mb-3 text-primary">
                <b>안심 서비스</b>
        ...
        <div class="py-5 col-md-6">
          <div class="row">
            <div class="text-center col-4">
              <img src="${pageContext.request.contextPath }/resources/start/main/img/main_catmate4.png">
            </div>
            <div class="col-8">
              <h5 class="mb-3 text-primary">
                <b>돌봄일지</b>
